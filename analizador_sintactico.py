...
def p_sent_fun(p):
    '''sent_fun : FUNCION IDENTIFICADORES A_PARENTESIS atributo C_PARENTESIS A_LLAVE sentencia_sent C_LLAVE
                | FUNCION IDENTIFICADORES A_PARENTESIS atributo C_PARENTESIS A_LLAVE sentencia_sent REGRESAR valor C_LLAVE'''
    if len(p)==9:
        p[0]=p[0] = {
            'tipo': 'sent_fun',
            'FUNCION':p[1],
